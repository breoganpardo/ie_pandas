...
@pytest.mark.parametrize('dictionary,expected_names',[
    ({'c0': [1], 'c1': [7], 'c2': [2], 'c3': [5]},['c0','c1','c2','c3']),
    ({'Col1':[2,3,5],'Col2':[5,6,8],'Col3':[10,45,7]},['Col1','Col2','Col3'])
])
...
@pytest.mark.parametrize('data,given_names,expected_names',[
    ([[1,3,4,7], [7,2,8,65], [2,3,21,54], [5,7,3,1]],None,['0','1','2','3']),
